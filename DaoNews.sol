...
uint256 public _burnFee = 200; //2% Burn
uint256 public _liquidityFee = 250; //2.5% Goes to Liquidity Wallet
...
if(xrpWalletShare > 0)
transferToAddressETH(CharityWalletAddress, xrpWalletShare);
}
if(forBurn > 0)
{
